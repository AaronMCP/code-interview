...
namespace Hys.Consultation.Application.Dtos.PatientCase
{
    public class NewEMRItemDto
    {
        ...
        private IEnumerable<NewEMRItemFileDto> _ItemFiles = new List<NewEMRItemFileDto>();
        public IEnumerable<NewEMRItemFileDto> ItemFiles
        {
            get { return _ItemFiles; }
            set { _ItemFiles = value; }
