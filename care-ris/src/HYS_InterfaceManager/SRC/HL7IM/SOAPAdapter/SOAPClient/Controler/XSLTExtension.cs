...
namespace HYS.IM.MessageDevices.SOAPAdapter.SOAPClient.Controler
{
    ...
    public class XSLTExtension
    {
        ...
        public static string GetValueByXPath(string xmlString, string xpath, string prefixDef)
        {
    ...
    public class XmlNodeTransformer
    {
        ...
        public string GetDescapingInnerText(string xpath)
        {
            return GetDescapingInnerText(xpath, null);
        }
        public string GetDescapingInnerText(string xpath, string prefixes)
        {
            if (xpath == null || xpath.Length < 1) return "";
            XmlNode node = FindXmlNode(xpath, prefixes);
            if (node == null) return "";
