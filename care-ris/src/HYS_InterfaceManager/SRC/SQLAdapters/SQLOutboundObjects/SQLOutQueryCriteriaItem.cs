...
{
    public class SQLOutQueryCriteriaItem : QueryCriteriaItem
    {
        ...
        public SQLOutQueryCriteriaItem()
        {
        }
        ...
        public SQLOutQueryCriteriaItem(string sourceName, string fixValue)
        {
        ...
        public SQLOutQueryCriteriaItem(GWDataDBField field, string fixValue)
        {
            Translating.Type = TranslatingType.FixValue;
            Translating.ConstValue = fixValue;
        ...
        public SQLOutQueryCriteriaItem(string targetName, ThrPartyDBParamter param)
        {
        ...
        public SQLOutQueryCriteriaItem(GWDataDBField targetfield, ThrPartyDBParamter param)
        {
        ...
        public SQLOutQueryCriteriaItem(ThrPartyDBParamter param, string sourceName)
        {
        ...
        public SQLOutQueryCriteriaItem(ThrPartyDBParamter param, GWDataDBField sourceField)
        {
            TargetField = param.FieldName;
        ...
        public SQLOutQueryCriteriaItem(ThrPartyDBParamter param, string sourceName, bool redundancyFlag)
        {
        ...
        public SQLOutQueryCriteriaItem(ThrPartyDBParamter param, GWDataDBField sourceField, bool redundancyFlag)
        {
            RedundancyFlag = redundancyFlag;
            TargetField = param.FieldName;
            SourceField = sourceField.GetFullFieldName();
