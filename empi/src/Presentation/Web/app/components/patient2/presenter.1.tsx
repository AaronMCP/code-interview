...
export class Patient extends React.Component<IPatient, {}> {
  ...
  // 右侧展示的病人信息
  @observable public patientInfoList: Array<any>;
  // 合并记录
    ...
    this.patientInfoList = [
      {
        bornProvince: 'asd',
        bornContry: 'asd',
        socialSecurityNo: 'asd',
        credentialType: 'asd',
        credentialNumber: 'asd',
        maritalStatus: 'asd',
        nationality: 'asd',
        phone: 'asd',
        address: 'asd'
      ...
      <div className='patient'>
        { this.mergeRecords ?
          ...
          <div className='patient-head'>
            ...
            <div className='patient-head-button-group'>
              ...
              <Button className='button-deactive' onClick={this.patientClickMerge}>合并</Button>
            </div>
          </div>
        }
        <div className='patient-content'>
          ...
          <div className='patient-info'>
            <PatientInfo
              IPatientInfo={this.patientInfoList}
            />
  ...
  public dataSourceRowRender = (record: any) => {
    ...
    return (
      <Table
        ...
        showHeader={false}
        expandedRowRender={(record: any) => this.mergeRowRender(record)}
        // expandedRowRender={(record: any) => this.moreDataSourceRowRender(record)}
        expandIconAsCell={false}
        expandIconColumnIndex={-1}
  ...
  // 更多源数据
  // public moreDataSourceRowRender = (record: any) => {
  //   return (
  //     <Table
  //       onRowClick={this.rowClickMerge}
  //       columns={this.mergeColumns}
  ...
  // 合并
  public patientClickMerge = () => {
    console.log('合并', this.selectedData);
  }
