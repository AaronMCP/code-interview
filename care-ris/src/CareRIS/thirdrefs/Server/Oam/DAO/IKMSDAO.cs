...
/*                                                                          */
/*                          Copyright 2008                                  */
/*                       CARESTREAM HEALTH COMPANY                          */
/*                        All Rights Reserved.                              */
/*                                                                          */
/*     This software contains proprietary and confidential information      */
/*     belonging to CARESTREAM HEALTH COMPANY, and may not be decompiled,   */
/*     disassembled, disclosed, reproduced or copied without the prior      */
/*     written consent of CARESTREAM HEALTH COMPANY.                        */
/*   Author : James Wei                                                     */
...
namespace Server.DAO.Oam
{
    public interface IKMSDAO
    {
        ...
        /// </summary>
        /// <returns>UpdatePath if rename node</returns>
        ...
        /// <summary>
        /// Name:CopyTo
        /// Function:CopyTo(string strGuid, string strParentID,string strSrcID,string strUserGuid,string isLeaf)
        /// </summary>
