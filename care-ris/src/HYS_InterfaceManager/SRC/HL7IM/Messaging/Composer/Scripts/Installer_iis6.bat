...
echo Installing IIS6 Virtual Directory...
...
call "%dest%\CreateVirtualPath_iis6.bat"
...
rem %systemroot%\system32\cscript.exe %systemroot%\system32\iisvdir.vbs /create W3SVC/1/Root "Renji_EMR_Integration" "%dest%\Portal" >> "%dest%\log\CreateVirtualPath_iis6.log"
