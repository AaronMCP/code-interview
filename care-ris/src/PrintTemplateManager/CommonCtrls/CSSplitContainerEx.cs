...
{
    public class CSSplitContainerEx : SplitContainer
    {
        ...
        public bool ExpendState
        {
            get
            {
                return _spliterPanelState == SpliterPanelState.Expanded ? true : false;
            }
