			...
			<Body>
				<xsl:for-each select="//MSH">
						...
						<ACK>
							...
							<MSA>
							<FIELD.1><FIELD_ITEM><xsl:text>AE</xsl:text></FIELD_ITEM></FIELD.1>
     
     <FIELD.2><xsl:copy-of select="FIELD.10/*"></xsl:copy-of></FIELD.2>
     
     <FIELD.3><FIELD_ITEM><xsl:text>Error</xsl:text></FIELD_ITEM></FIELD.3>
     
     <FIELD.4><FIELD_ITEM></FIELD_ITEM></FIELD.4>
     
     <FIELD.5><FIELD_ITEM></FIELD_ITEM></FIELD.5>     
