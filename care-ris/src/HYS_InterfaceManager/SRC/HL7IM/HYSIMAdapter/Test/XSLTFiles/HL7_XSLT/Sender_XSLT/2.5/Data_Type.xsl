		...
		<FIELD_ITEM>
                     ...
                     <COMPONENT.5>
                         <xsl:if test="count(Unit/@* ) > 0">
                             <SUBCOMPONENT.1><xsl:value-of select="Unit/@Identifier"/></SUBCOMPONENT.1>
                             <SUBCOMPONENT.2><xsl:value-of select="Unit/@Text"/></SUBCOMPONENT.2>
                             <SUBCOMPONENT.3><xsl:value-of select="Unit/@NameOfCodingSystem"/></SUBCOMPONENT.3>
                             <SUBCOMPONENT.4><xsl:value-of select="Unit/@AlternateIdentifier"/></SUBCOMPONENT.4>
                             <SUBCOMPONENT.5><xsl:value-of select="Unit/@AlternateText"/></SUBCOMPONENT.5>
                             <SUBCOMPONENT.6><xsl:value-of select="Unit/@NameOfAlternateCodingSystem"/></SUBCOMPONENT.6>
                         </xsl:if>
                     </COMPONENT.5>
...
<FIELD_ITEM>
										 <COMPONENT.1><xsl:value-of select="@SegmentFieldName"/></COMPONENT.1>
										 <COMPONENT.2><xsl:value-of select="@Value"/></COMPONENT.2>										 
								 </FIELD_ITEM>	
	</xsl:template>
	
	<xsl:template name="SRT">
		<FIELD_ITEM>
                     <COMPONENT.1> <xsl:value-of select="@SortByField"/></COMPONENT.1>
                     <COMPONENT.2> <xsl:value-of select="@Sequencing"/></COMPONENT.2>
                 </FIELD_ITEM>
	</xsl:template>
</xsl:stylesheet>
