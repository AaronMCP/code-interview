<xsl:stylesheet version="1.1" 
  ...
  <msxsl:script language="C#" implements-prefix="myscript">
    ...
    public string ReplaceString(string source, string pattern, string replacement)
    {
...
<!--			<xsl:value-of select="$PatName"/>-->
	...
	<xsl:template name="REPORT">
      ...
      <xsl:variable name="str1">
        <xsl:value-of select="myscript:ReplaceString($str0,'\T\','&amp;')"/>
        <!--<xsl:call-template name="replaceCharsInString">
      ...
      <xsl:variable name="str2">
        <xsl:value-of select="myscript:ReplaceString($str1,'\R\','~')"/>
        <!--<xsl:call-template name="replaceCharsInString">
      ...
      <xsl:variable name="str3">
        <xsl:value-of select="myscript:ReplaceString($str2,'\S\','^')"/>
        <!--<xsl:call-template name="replaceCharsInString">
      ...
      <xsl:variable name="str4">
        <xsl:value-of select="myscript:ReplaceString($str3,'\F\','|')"/>
        <!--<xsl:call-template name="replaceCharsInString">
