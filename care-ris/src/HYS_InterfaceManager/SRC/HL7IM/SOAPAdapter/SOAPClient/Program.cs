...
using HYS.IM.MessageDevices.SOAPAdapter.SOAPClient.Forms;
...
namespace HYS.IM.MessageDevices.SOAPAdapter.SOAPClient
{
    ...
    public class ProgramContext
    {
        ...
        public string AppName = "SOAPClientAdapter";
        public ConfigManager<SOAPClientConfig> ConfigMgr;
        ...
        internal void PreLoading(EntityInitializeArgument arg)
        {
            ...
            string FileName = ConfigHelper.GetFullPath(Path.Combine(arg.ConfigFilePath, SOAPClientConfig.SOAPClientConfigFileName));

            ConfigMgr = new ConfigManager<SOAPClientConfig>(FileName);
        ...
        internal void CreateDefaultConfig()
        {
            try
            {
                SOAPClientConfig cfg = new SOAPClientConfig();
