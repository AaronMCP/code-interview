...
echo Deleting IIS6 Virtual Directory...

call "%dest%\DropVirtualPath_iis6.bat"

rem mkdir "%dest%\log"
rem %systemroot%\system32\cscript.exe %systemroot%\system32\iisvdir.vbs /delete W3SVC/1/Root/Renji_EMR_Integration >> "%dest%\log\DropVirtualPath_iis6.log"
