...
{
    public class RequestListMapper : EntityTypeConfiguration<RequestList>
    {
        public RequestListMapper()
        {
            this.ToTable("dbo.tbRequestList");
            //[EAcquisition]
            this.HasKey(u => u.UniqueID);
            this.Property(u => u.UniqueID).IsRequired().HasColumnName("tRequestListID").HasMaxLength(64);
            ...
            this.Property(u => u.RequestItem).IsOptional();
            this.Property(u => u.RequestCharge).IsOptional();
            this.Property(u => u.PutinTime).HasColumnName("PutinDt").IsOptional();
