...
{
    public class SocketClientWithLongConnection : IClient
    {
        public const string DEVICE_NAME = "MULTIPLE_SESSION_PER_CONNECTION_CLIENT";

        public readonly SocketClientConfig Config;
        public SocketClientWithLongConnection(SocketClientConfig cfg)
        {
            Config = cfg;

            if (Config == null)
                throw new ArgumentNullException("The constructor of the class SocketClientWithLongConnection does not accept null in the cfg parameter.");
        }
        public SocketClientWithLongConnection()
