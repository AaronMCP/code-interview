...
{
    internal sealed class FtpClientCore
    {
        private static int BUFFER_SIZE = 8192;
        private static Encoding ASCII = Encoding.ASCII;
        private static Encoding GB2312Coding = Encoding.GetEncoding("GB2312");
        ...
        /// </summary>
        /// <param name="server">The Server Address or IP</param>
        /// <param name="username">Username to login</param>
        /// <param name="password">Password to login</param>
        public FtpClientCore(string server, string username, string password)
        {
            this.server = server;
        ...
        /// <param name="username">Username to login</param>
        /// <param name="password">Password to login</param>
        /// <param name="timeoutSeconds">Timeour secondes.</param>
        /// <param name="port">The Port of the FTP.</param>
        public FtpClientCore(string server, string username, string password, int timeoutSeconds, int port)
        {
            this.server = server;
            this.username = username;
            this.password = password;
        ...
        public void Download(string remFileName, string locFileName, Boolean resume)
        {
            ...
            //delete local file when error occurs.
            {
                if (output != null)
                    output.Close();
                if (File.Exists(locFileName))
        ...
        private void sendCommand(String command)
        {
            ...
            {
                cmdBytes = GB2312Coding.GetBytes((command + "\r\n").ToCharArray());
            }
            else
            {
                cmdBytes = Encoding.Default.GetBytes((command + "\r\n").ToCharArray());
            }
        ...
        private bool IsContainChinese(string inputStr)
        {
            byte[] uniCodeBytes = Encoding.Unicode.GetBytes(inputStr.ToCharArray());
