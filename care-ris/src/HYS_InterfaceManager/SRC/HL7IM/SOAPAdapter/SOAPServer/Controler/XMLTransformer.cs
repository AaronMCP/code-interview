...
{
    /// <summary>
    /// This XMLTransformer is the initial prototype of XMLTransformer in the Messaging.Mapping namespace.
    /// We do not replace this XMLTransformer with the XMLTransformer in the Messaging.Mapping namespace,
    /// because SOAP Adapter may need some special extensions in the future when processing SOAP messages.
    /// </summary>
