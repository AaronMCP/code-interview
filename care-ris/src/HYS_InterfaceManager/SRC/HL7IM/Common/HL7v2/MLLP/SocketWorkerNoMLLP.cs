...
{
    public class SocketWorkerNoMLLP : ISocketWorker
    {
        public const string DEVICE_NAME = "NO_MLLP_SINGLE_SESSION_WORKER";
        ...
        internal SocketWorkerNoMLLP(int id, Socket socket, SocketServer server)
        {
            _server = server;
            _socket = socket;
            UpdateActiveDT();
