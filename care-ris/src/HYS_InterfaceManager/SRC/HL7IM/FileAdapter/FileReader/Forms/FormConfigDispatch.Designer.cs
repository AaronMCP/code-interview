namespace HYS.IM.MessageDevices.FileAdapter.FileReader.Forms
{
    partial class FormConfigDispatch
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.radioButtonCustom.Text = "The value of the following XPath determines where the XDS Gateway message would b" +
                "e dispatched.";
            ...
            this.radioButtonRequest.Enabled = false;
            ...
            this.radioButtonRequest.Text = "Dispatch all XDS Gateway message to request channel.";
            ...
            this.radioButtonPublish.Text = "Dispatch all XDS Gateway message to publish channel.";
            ...
            this.textBoxValueResponser.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            this.textBoxValueResponser.Enabled = false;
            ...
            this.label9.Text = "The value of the previous XPath in XDS Gateway message matches the following regu" +
                "lar expression will be dispatched to request channel:";
            ...
            this.label6.Text = "The value of the previous XPath in XDS Gateway message matches the following regu" +
                "lar expression will be dispatched to publish channel:";
