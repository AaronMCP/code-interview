...
{
    public class ConsultatReportTemplateMapper : EntityTypeConfiguration<ConsultatReportTemplate>
    {
        public ConsultatReportTemplateMapper()
        {
            this.ToTable("dbo.tbConsultatReportTemplate");
