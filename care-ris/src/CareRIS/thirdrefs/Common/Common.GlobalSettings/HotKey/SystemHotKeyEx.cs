...
using CommonGlobalSettings.Win32;

namespace CommonGlobalSettings.SystemHotkey
{
    /// <summary>
    /// Handles a System Hotkey
    /// </summary>
    public class SystemHotkeyEx : System.ComponentModel.Component, IDisposable
    {
        private System.ComponentModel.Container components = null;
        protected DummyWindowWithEvent m_Window;	//window for WM_Hotkey Messages
        ...
        public SystemHotkeyEx(System.ComponentModel.IContainer container, IntPtr _handle)
        {
            m_Window = new DummyWindowWithEvent(_handle);
            container.Add(this);
            InitializeComponent();
        ...
        {	//Handle WM_Hotkey event
            Win32.DummyWindowWithEvent ctrl = (Win32.DummyWindowWithEvent)sender;
            if (ctrl.Handle == this.m_Window.Handle)
            {
