...
namespace HYS.Common.Objects.Config
{
    public class ConfigHelper
    {
        ...
        public const string ComposerDefaultFileName = "HYS.Adapter.Composer.config";
        public const string MonitorDefaultFileName = "HYS.Adapter.Monitor.config";
        public const string ServiceDefaultFileName = "HYS.Adapter.Service.config";
        public const string ConfigDefaultFileName = "HYS.Adapter.Config.config";
        public const string IMDefaultCaption = "HYS - Interface Manager";
        public const string IMDefaultFileName = "HYS.IM.config";
        public const string IMInterfaceFolder = "Interface";
        public const string IMDeviceFolder = "Device";
