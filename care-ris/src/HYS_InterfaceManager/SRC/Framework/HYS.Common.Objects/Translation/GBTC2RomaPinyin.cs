...
{
    public class GBK2RomaPinyin : PinyinBase
    {
        ...
        private static GBK2RomaPinyin _instance;
        public static GBK2RomaPinyin Instance
        {
            get
            {
                if (_instance == null) _instance = new GBK2RomaPinyin();
                return _instance;
            }
        }
    }
