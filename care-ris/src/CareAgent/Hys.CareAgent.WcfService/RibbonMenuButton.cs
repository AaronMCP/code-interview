        ...
        public void DrawImage(Graphics gr)
        {
            if (this.Image != null)
            {
                ...
                else
                {
                    ...
                    {
                        case e_imagelocation.Left:
                            gr.DrawImage(this.Image, new Rectangle(offsetx, offsety, imagewidth, imageheight), 0, 0, Image.Width, Image.Height, GraphicsUnit.Pixel, ia);
                            break;
                        case e_imagelocation.Right:
                            gr.DrawImage(this.Image, new Rectangle(this.Width - imagewidth - offsetx, offsety, imagewidth, imageheight), 0, 0, Image.Width, Image.Height, GraphicsUnit.Pixel, ia);
                            break;
                        case e_imagelocation.Top:
                            offsetx = this.Width / 2 - imagewidth / 2;
                            gr.DrawImage(this.Image, new Rectangle(offsetx, offsety, imagewidth, imageheight), 0, 0, Image.Width, Image.Height, GraphicsUnit.Pixel, ia);
                            break;
                        case e_imagelocation.Bottom:
                            gr.DrawImage(this.Image, new Rectangle(offsetx, this.Height - imageheight - offsety, imagewidth, imageheight), 0, 0, Image.Width, Image.Height, GraphicsUnit.Pixel, ia);
                            break;
                        default:
                            break;
                    }
            ...
            if (this.Text != "")
            {
                ...
                switch (_imagelocation)
                {
                    ...
                    case e_imagelocation.Center:
                        gr.DrawString(this.Text, this.Font, new SolidBrush(_forecolor), new PointF(this.Width / 2 - textwidth / 2 - 1, this.Height / 2 - this.Font.Size + 1));
                        break;
                    case e_imagelocation.Bottom:
