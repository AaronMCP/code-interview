<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.1">
		...
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' ">
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.3!= ''">
					<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.3"/></xsl:attribute>
				</xsl:if>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="."/>
			...
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != ''">
				...
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:element name="InternationalizationCode">
						<xsl:choose>
							<xsl:when test="COMPONENT.2/SUBCOMPONENT.1 != '' or COMPONENT.2/SUBCOMPONENT.2 != ''  or COMPONENT.2/SUBCOMPONENT.3 != ''
									                           or COMPONENT.2/SUBCOMPONENT.4 != ''  or COMPONENT.2/SUBCOMPONENT.5 != ''  or COMPONENT.2/SUBCOMPONENT.6 != ''">
							...
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.3 != ''">
					<xsl:element name="InternationalVersionID">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.3"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="CX">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or 
				...
				<xsl:if test="COMPONENT.5 != ''">
					<xsl:attribute name="IdentifierTypeCodeID"><xsl:value-of select="COMPONENT.5"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.7 != ''">
					<xsl:attribute name="EffectiveDate"><xsl:value-of select="COMPONENT.7"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.8 != ''">
					<xsl:attribute name="ExpirationDate"><xsl:value-of select="COMPONENT.8"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.4 != ''">
				...
				<xsl:if test="COMPONENT.9 != ''">
					<xsl:element name="AssigningJurisdiction">
						<xsl:choose>
							<xsl:when test="COMPONENT.9/SUBCOMPONENT.1 != '' or COMPONENT.9/SUBCOMPONENT.2 != '' or COMPONENT.9/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.9/SUBCOMPONENT.4 != '' or COMPONENT.9/SUBCOMPONENT.5 != '' or COMPONENT.9/SUBCOMPONENT.6 != '' or
										                                    COMPONENT.9/SUBCOMPONENT.7 != '' or COMPONENT.9/SUBCOMPONENT.8 != '' or COMPONENT.9/SUBCOMPONENT.9 != ''">
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="Text"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="NameOfCodingSystem"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="AlternateIdentifier"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="AlternateText"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.6 != ''">
									<xsl:attribute name="NameOfAlternateCodingSystem"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.6"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.7 != ''">
									<xsl:attribute name="CodingSystemVersionID"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.7"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.8 != ''">
									<xsl:attribute name="AlternateCodingSystemVersionID"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.8"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.9 != ''">
									<xsl:attribute name="OriginalText"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.9"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.9"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:element name="AssigningAgencyOrDepartment">
						<xsl:choose>
							<xsl:when test="COMPONENT.10/SUBCOMPONENT.1 != '' or COMPONENT.10/SUBCOMPONENT.2 != '' or COMPONENT.10/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.10/SUBCOMPONENT.4 != '' or COMPONENT.10/SUBCOMPONENT.5 != '' or COMPONENT.10/SUBCOMPONENT.6 != '' or
										                                    COMPONENT.10/SUBCOMPONENT.7 != '' or COMPONENT.10/SUBCOMPONENT.8 != '' or COMPONENT.10/SUBCOMPONENT.9 != ''">
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="Text"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="NameOfCodingSystem"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="AlternateIdentifier"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="AlternateText"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.6 != ''">
									<xsl:attribute name="NameOfAlternateCodingSystem"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.6"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.7 != ''">
									<xsl:attribute name="CodingSystemVersionID"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.7"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.8 != ''">
									<xsl:attribute name="AlternateCodingSystemVersionID"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.8"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.9 != ''">
									<xsl:attribute name="OriginalText"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.9"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="XPN">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or COMPONENT.6 != '' or COMPONENT.7 != '' or
							                                COMPONENT.8 != '' or COMPONENT.9 != '' or COMPONENT.10 != '' or COMPONENT.11 != '' or COMPONENT.12 != '' or COMPONENT.13 != '' or COMPONENT.14 != ''">
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:attribute name="GivenName"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.3 != ''">
					<xsl:attribute name="SecondAndFurtherGivenNamesOrInitialsThereof"><xsl:value-of select="COMPONENT.3"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.4 != ''">
					<xsl:attribute name="Suffix"><xsl:value-of select="COMPONENT.4"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.5 != ''">
					<xsl:attribute name="Prefix"><xsl:value-of select="COMPONENT.5"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.6 != ''">
					<xsl:attribute name="Degree"><xsl:value-of select="COMPONENT.6"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.7 != ''">
					<xsl:attribute name="NameTypeCode"><xsl:value-of select="COMPONENT.7"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:attribute name="NameAssemblyOrder"><xsl:value-of select="COMPONENT.11"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.12 != ''">
					<xsl:attribute name="EffectiveDate"><xsl:value-of select="COMPONENT.12"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.13 != ''">
					<xsl:attribute name="ExpirationDate"><xsl:value-of select="COMPONENT.13"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.14 != ''">
					<xsl:attribute name="ProfessionalSuffix"><xsl:value-of select="COMPONENT.14"/></xsl:attribute>
				</xsl:if>
				<xsl:choose>
					<xsl:when test="COMPONENT.8 != ''">
						<xsl:attribute name="NameRepresentationCode"><xsl:value-of select="COMPONENT.8"/></xsl:attribute>
					</xsl:when>
					<xsl:otherwise>
						<xsl:attribute name="NameRepresentationCode"><xsl:text>A</xsl:text></xsl:attribute>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:element name="FamilyName">
						<xsl:choose>
							<xsl:when test="COMPONENT.1/SUBCOMPONENT.1 != '' or COMPONENT.1/SUBCOMPONENT.2 != '' or COMPONENT.1/SUBCOMPONENT.3 != '' or 
											                                COMPONENT.1/SUBCOMPONENT.4 != '' or COMPONENT.1/SUBCOMPONENT.5 != ''">
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Surname"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="OwnSurnamePrefix"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="OwnSurname"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="SurnamePrefixFromPartnerSpouse"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="SurnameFromPartnerSpouse"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Surname"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.9 != ''">
					<xsl:element name="NameContext">
						<xsl:choose>
							<xsl:when test="COMPONENT.9/SUBCOMPONENT.1 != '' or COMPONENT.9/SUBCOMPONENT.2 != '' or COMPONENT.9/SUBCOMPONENT.3 != '' or 
											                                COMPONENT.9/SUBCOMPONENT.4 != '' or COMPONENT.9/SUBCOMPONENT.5 != '' or COMPONENT.9/SUBCOMPONENT.6 != ''">
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.2 != ''">
				...
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:element name="NameValidityRange">
						<xsl:choose>
							<xsl:when test="COMPONENT.10/SUBCOMPONENT.1 != '' or COMPONENT.10/SUBCOMPONENT.2 != ''">
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="RangeEndDateTime"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="XAD">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or COMPONENT.6 != '' or COMPONENT.7 != '' or
				...
				<xsl:if test="COMPONENT.13 != ''">
					<xsl:attribute name="EffectiveDate"><xsl:value-of select="COMPONENT.13"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.14 != ''">
					<xsl:attribute name="ExpirationDate"><xsl:value-of select="COMPONENT.14"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:element name="StreetAddress">
						<xsl:choose>
							<xsl:when test="COMPONENT.1/SUBCOMPONENT.1 != '' or COMPONENT.1/SUBCOMPONENT.2 != '' or COMPONENT.1/SUBCOMPONENT.3 != ''">
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="StreetOrMailingAddress"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="StreetName"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.1/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="DwellingNumber"><xsl:value-of select="COMPONENT.1/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="StreetOrMailingAddress"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.12 != ''">
					<xsl:element name="AddressValidityRange">
						<xsl:choose>
							<xsl:when test="COMPONENT.12/SUBCOMPONENT.1 != '' or COMPONENT.12/SUBCOMPONENT.2 != ''">
								<xsl:if test="COMPONENT.12/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.12/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.12/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="RangeEndDateTime"><xsl:value-of select="COMPONENT.12/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.12"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="XTN">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or COMPONENT.6 != '' or
				...
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:attribute name="TelephoneNumber"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.2 != ''">
				...
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:attribute name="ExtensionPrefix"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:attribute name="SpeedDialCode"><xsl:value-of select="COMPONENT.11"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.12 != ''">
					<xsl:attribute name="UnformattedTelephoneNumber"><xsl:value-of select="COMPONENT.12"/></xsl:attribute>
				</xsl:if>
			</xsl:when>
			<xsl:otherwise>
				<xsl:attribute name="TelephoneNumber"><xsl:value-of select="."/></xsl:attribute>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	...
	<xsl:template name="CWE">
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:attribute name="Identifier"><xsl:value-of select="."/></xsl:attribute>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
	<xsl:template name="CNE">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or 
							                                COMPONENT.6 != '' or COMPONENT.7 != '' or COMPONENT.8 != '' or COMPONENT.9 != ''">
				<xsl:if test="COMPONENT.1 != ''">
	...
	<xsl:template name="PL">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or
							                                COMPONENT.6 != '' or COMPONENT.7 != '' or COMPONENT.8 != '' or COMPONENT.9 != '' or COMPONENT.10 != '' or COMPONENT.11 != ''">
				<xsl:if test="COMPONENT.1 != ''">
				...
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:element name="ComprehensiveLocationIdentifier">
						<xsl:choose>
							<xsl:when test="COMPONENT.10/SUBCOMPONENT.1 != '' or COMPONENT.10/SUBCOMPONENT.2 != '' or 
										                                    COMPONENT.10/SUBCOMPONENT.3 != '' or COMPONENT.10/SUBCOMPONENT.4 != ''">
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="EntityIdentifier"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.10/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.10/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="EntityIdentifier"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:element name="AssigningAuthorityforLocation">
						<xsl:choose>
							<xsl:when test="COMPONENT.11/SUBCOMPONENT.1 != '' or COMPONENT.11/SUBCOMPONENT.2 != '' or COMPONENT.11/SUBCOMPONENT.3 != ''">
								<xsl:if test="COMPONENT.11/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.11/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.11/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.11/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.11/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.11/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.11"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="XCN">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or COMPONENT.6 != '' or 
							                                ...
							                                COMPONENT.13 != '' or COMPONENT.14 != '' or COMPONENT.15 != '' or COMPONENT.16 != '' or COMPONENT.17 != '' or  COMPONENT.18 != '' or 
							                                COMPONENT.19 != '' or COMPONENT.20 != '' or COMPONENT.21 != '' or COMPONENT.22 != '' or COMPONENT.23 != ''">
				<xsl:if test="COMPONENT.1 != ''">
				...
				<xsl:if test="COMPONENT.4 != ''">
					<xsl:attribute name="SecondAndFurtherGivenNamesOrInitialsThereof"><xsl:value-of select="COMPONENT.4"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.5 != ''">
				...
				<xsl:if test="COMPONENT.8 != ''">
					<xsl:attribute name="SourceTable"><xsl:value-of select="COMPONENT.8"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:attribute name="NameTypeCode"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:attribute name="IdentifierCheckDigit"><xsl:value-of select="COMPONENT.11"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.12 != ''">
					<xsl:attribute name="CodeIdentifyingTheCheckDigitSchemeEmployed"><xsl:value-of select="COMPONENT.12"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.13 != ''">
					<xsl:attribute name="IdentifierTypeCode"><xsl:value-of select="COMPONENT.13"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.15 != ''">
					<xsl:attribute name="NameRepresentationCode"><xsl:value-of select="COMPONENT.15"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.18 != ''">
					<xsl:attribute name="NameAssemblyOrder"><xsl:value-of select="COMPONENT.18"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.19 != ''">
					<xsl:attribute name="EffectiveDate"><xsl:value-of select="COMPONENT.19"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.20 != ''">
					<xsl:attribute name="ExpirationDate"><xsl:value-of select="COMPONENT.20"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.21 != ''">
					<xsl:attribute name="ProfessionalSuffix"><xsl:value-of select="COMPONENT.21"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:element name="FamilyName">
						<xsl:choose>
							<xsl:when test="COMPONENT.2/SUBCOMPONENT.1 != '' or COMPONENT.2/SUBCOMPONENT.2 != '' or COMPONENT.2/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.2/SUBCOMPONENT.4 != '' or COMPONENT.2/SUBCOMPONENT.4 != ''">
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Surname"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="OwnSurnamePrefix"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="OwnSurname"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="SurnamePrefixFromPartnerSpouse"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="SurnameFromPartnerSpouse"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Surname"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.9 != ''">
					<xsl:element name="AssigningAuthority">
						<xsl:choose>
							<xsl:when test="COMPONENT.9/SUBCOMPONENT.1 != '' or COMPONENT.9/SUBCOMPONENT.2 != '' or COMPONENT.9/SUBCOMPONENT.3 != ''">
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.9/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.9/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.9"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.14 != ''">
					<xsl:element name="AssigningFacility">
						<xsl:choose>
							<xsl:when test="COMPONENT.14/SUBCOMPONENT.1 != '' or COMPONENT.14/SUBCOMPONENT.2 != '' or COMPONENT.14/SUBCOMPONENT.3 != ''">
								<xsl:if test="COMPONENT.14/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.14/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.14/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.14/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.14/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.14/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.14"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.16 != ''">
					<xsl:element name="NameContext">
						<xsl:choose>
							<xsl:when test="COMPONENT.16/SUBCOMPONENT.1 != '' or COMPONENT.16/SUBCOMPONENT.2 != '' or COMPONENT.16/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.16/SUBCOMPONENT.4 != '' or COMPONENT.16/SUBCOMPONENT.5 != '' or COMPONENT.16/SUBCOMPONENT.6 != ''">
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="Text"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="NameOfCodingSystem"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="AlternateIdentifier"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="AlternateText"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.16/SUBCOMPONENT.6 != ''">
									<xsl:attribute name="NameOfAlternateCodingSystem"><xsl:value-of select="COMPONENT.16/SUBCOMPONENT.6"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.16"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.17 != ''">
					<xsl:element name="NameValidityRange">
						<xsl:choose>
							<xsl:when test="COMPONENT.17/SUBCOMPONENT.1 != '' or COMPONENT.17/SUBCOMPONENT.2 != ''">
								<xsl:if test="COMPONENT.17/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.17/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.17/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="RangeEndDateTime"><xsl:value-of select="COMPONENT.17/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="RangeStartDateTime"><xsl:value-of select="COMPONENT.17"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.22 != ''">
					<xsl:element name="AssigningJurisdiction">
						<xsl:choose>
							<xsl:when test="COMPONENT.22/SUBCOMPONENT.1 != '' or COMPONENT.22/SUBCOMPONENT.2 != '' or COMPONENT.22/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.22/SUBCOMPONENT.4 != '' or COMPONENT.22/SUBCOMPONENT.5 != '' or COMPONENT.22/SUBCOMPONENT.6 != '' or
										                                    COMPONENT.22/SUBCOMPONENT.7 != '' or COMPONENT.22/SUBCOMPONENT.8 != '' or COMPONENT.22/SUBCOMPONENT.9 != ''">
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="Text"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="NameOfCodingSystem"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="AlternateIdentifier"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="AlternateText"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.6 != ''">
									<xsl:attribute name="NameOfAlternateCodingSystem"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.6"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.7 != ''">
									<xsl:attribute name="CodingSystemVersionID"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.7"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.8 != ''">
									<xsl:attribute name="AlternateCodingSystemVersionID"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.8"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.22/SUBCOMPONENT.9 != ''">
									<xsl:attribute name="OriginalText"><xsl:value-of select="COMPONENT.22/SUBCOMPONENT.9"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.22"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				<xsl:if test="COMPONENT.23 != ''">
					<xsl:element name="AssigningAgencyorDepartment">
						<xsl:choose>
							<xsl:when test="COMPONENT.23/SUBCOMPONENT.1 != '' or COMPONENT.23/SUBCOMPONENT.2 != '' or COMPONENT.23/SUBCOMPONENT.3 != '' or
										                                    COMPONENT.23/SUBCOMPONENT.4 != '' or COMPONENT.23/SUBCOMPONENT.5 != '' or COMPONENT.23/SUBCOMPONENT.6 != '' or
										                                    COMPONENT.23/SUBCOMPONENT.7 != '' or COMPONENT.23/SUBCOMPONENT.8 != '' or COMPONENT.23/SUBCOMPONENT.9 != ''">
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="Text"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="NameOfCodingSystem"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.4 != ''">
									<xsl:attribute name="AlternateIdentifier"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.4"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.5 != ''">
									<xsl:attribute name="AlternateText"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.5"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.6 != ''">
									<xsl:attribute name="NameOfAlternateCodingSystem"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.6"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.7 != ''">
									<xsl:attribute name="CodingSystemVersionID"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.7"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.8 != ''">
									<xsl:attribute name="AlternateCodingSystemVersionID"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.8"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.23/SUBCOMPONENT.9 != ''">
									<xsl:attribute name="OriginalText"><xsl:value-of select="COMPONENT.23/SUBCOMPONENT.9"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.23"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="EI">
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:attribute name="EntityIdentifier"><xsl:value-of select="."/></xsl:attribute>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
				...
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:element name="PerformanceDuration">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="COMPONENT.11"/>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="EIP">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != ''">
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:element name="RequestAllocationID">
						<xsl:choose>
				...
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:element name="ImplementAllocationID">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:attribute name="EntityIdentifier"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="CQ">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or COMPONENT.6 != '' or COMPONENT.7 != '' or
							                                COMPONENT.8 != '' or COMPONENT.9 != '' or COMPONENT.10 != '' or COMPONENT.11 != '' or COMPONENT.12 != ''">
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:attribute name="Interval"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.3 != ''">
					<xsl:attribute name="Duration"><xsl:value-of select="COMPONENT.3"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.4 != ''">
					<xsl:attribute name="StartDateTime"><xsl:value-of select="COMPONENT.4"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.5 != ''">
					<xsl:attribute name="EndDateTime"><xsl:value-of select="COMPONENT.5"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.6 != ''">
					<xsl:attribute name="Priority"><xsl:value-of select="COMPONENT.6"/></xsl:attribute>
				</xsl:if>
				...
				<xsl:if test="COMPONENT.12 != ''">
					<xsl:attribute name="TotalOccurrences"><xsl:value-of select="COMPONENT.12"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:element name="Quantity">
						<xsl:choose>
				...
				<xsl:if test="COMPONENT.11 != ''">
					<xsl:element name="OccurrenceDuration">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:attribute name="Identifier"><xsl:value-of select="COMPONENT.11"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
				...
				<xsl:if test="COMPONENT.7 != ''">
					<xsl:element name="Facility">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="COMPONENT.7 "/>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="XON">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != '' or COMPONENT.4 != '' or COMPONENT.5 != '' or 
				...
				<xsl:if test="COMPONENT.10 != ''">
					<xsl:attribute name="OrganizationIdentifier"><xsl:value-of select="COMPONENT.10"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.6 != ''">
					<xsl:element name="AssigningAuthority">
						<xsl:choose>
				...
				<xsl:if test="COMPONENT.8 != ''">
					<xsl:element name="AssigningFacilityID">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.8"/></xsl:attribute>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
			...
			<xsl:otherwise>
				<xsl:attribute name="OrganizationName"><xsl:value-of select="."/></xsl:attribute>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:template>
				...
				<xsl:if test="COMPONENT.5 != ''">
					<xsl:element name="Units">
						<xsl:choose>
							...
							<xsl:otherwise>
								<xsl:value-of select="COMPONENT.5"/>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:element>
				</xsl:if>
	...
	<xsl:template name="QIP">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != ''">
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:attribute name="SegmentFieldName"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:attribute name="Value"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
				</xsl:if>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="."/>
	...
	<xsl:template name="RP">
		<xsl:choose>
			<xsl:when test="COMPONENT.1 != '' or COMPONENT.2 != '' or COMPONENT.3 != ''or COMPONENT.4 != ''">
				<xsl:if test="COMPONENT.1 != ''">
					<xsl:attribute name="Pointer"><xsl:value-of select="COMPONENT.1"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.3 != ''">
					<xsl:attribute name="DataOfType"><xsl:value-of select="COMPONENT.3"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.4 != ''">
					<xsl:attribute name="SubType"><xsl:value-of select="COMPONENT.4"/></xsl:attribute>
				</xsl:if>
				<xsl:if test="COMPONENT.2 != ''">
					<xsl:element name="ApplicationID">
						<xsl:choose>
							<xsl:when test="COMPONENT.2/SUBCOMPONENT.1 != '' or COMPONENT.2/SUBCOMPONENT.2 != ''  or COMPONENT.2/SUBCOMPONENT.3 != ''">
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.1 != ''">
									<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.1"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.2 != ''">
									<xsl:attribute name="UniversalID"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.2"/></xsl:attribute>
								</xsl:if>
								<xsl:if test="COMPONENT.2/SUBCOMPONENT.3 != ''">
									<xsl:attribute name="UniversalIDType"><xsl:value-of select="COMPONENT.2/SUBCOMPONENT.3"/></xsl:attribute>
								</xsl:if>
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="NameSpaceID"><xsl:value-of select="COMPONENT.2"/></xsl:attribute>
