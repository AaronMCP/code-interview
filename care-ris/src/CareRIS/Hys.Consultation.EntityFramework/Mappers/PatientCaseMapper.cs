...
{
    public class PatientCaseMapper : EntityTypeConfiguration<PatientCase>
    {
        public PatientCaseMapper()
        {
            this.ToTable("dbo.tbPatientCase");
            this.HasKey(u => u.UniqueID);

            this.Property(u => u.UniqueID).IsRequired().HasColumnName("PatientCaseID").HasMaxLength(128);
            ...
            this.Property(u => u.OrderID).HasColumnName("OrderID").IsOptional().HasMaxLength(128);
        }
    }
}
